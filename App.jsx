...
function LmsEnterprisePortal() {
  ...
  const handleConfirmAddItem = async (e) => {
    ...
    // Inicializa Banco de Dados de Componentes Complexos
  ...
  const renderExamModal = () => {
    ...
    // VISÃO DE RESOLUÇÃO DE PROVA (ALUNO, OU PROFESSOR TESTANDO)
